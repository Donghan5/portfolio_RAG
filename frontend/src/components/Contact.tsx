  ...
  return (
    <footer className="border-t border-border">
      <section className="section-wrap py-16 text-center">
        <p className="eyebrow">Let’s connect</p><h2 className="section-title">Let’s build something useful.</h2>
        <p className="section-copy mx-auto mt-2">Open to software engineering, machine learning engineering, and forward deployment opportunities.</p>
