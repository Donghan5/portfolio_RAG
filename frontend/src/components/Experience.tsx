  ...
  return (
    <div className="relative z-10">
      <div className="max-w-[720px] mx-auto px-8 py-[7.3rem] text-center">
        ...
        {experiences.map((exp) => (
          <div key={exp.title} className="py-10 border-t border-border last:border-b">
            <span className="block font-mono text-[11px] tracking-[0.14em] uppercase text-text-subtle mb-1">
              {exp.period}
            </span>
            <span className="block font-mono text-[11px] tracking-[0.18em] uppercase text-primary mb-4">
              {exp.type}
            </span>
